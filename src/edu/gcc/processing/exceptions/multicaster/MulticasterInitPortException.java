 ...
 * connection to a specific port fails but further actions can be attempted to
 * remedy the issue
 *
 * @category   Exceptions
 * @package    edu.gcc.processing.exceptions.multicaster
...
public class MulticasterInitPortException extends ExceptionBase {
/**
 ...
 * @since      v0.1 Dev
 */
	public MulticasterInitPortException(String message, Exception e, PApplet applet) {
